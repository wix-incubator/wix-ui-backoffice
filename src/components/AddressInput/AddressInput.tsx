...
} from 'wix-ui-core/address-input';
...
export interface AddressInputProps
  extends Omit<CoreAddressInputProps, excludeProps> {
  ...
  render() {
    ...
    return (
      <CoreAddressInput
        ...
        suffix={
          magnifyingGlass ? <Search className={style.search} /> : undefined
        }
